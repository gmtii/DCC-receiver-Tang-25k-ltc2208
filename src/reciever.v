module reciever(
  ...
  output decim_avail_o          // <-- NUEVO

  );

assign decim_avail_o = decim_avail;
...
cordic rx_cordic (
    ...
    .frequency(rx_tune_phase),          // 32 bit rx_tune_phase
...
//I channel
cic #(.STAGES(3), .DECIMATION(16), .IN_WIDTH(22), .ACC_WIDTH(31), .OUT_WIDTH(18))      
  cic_inst_I1(
    .clock(clock),
    .in_strobe(1'b1),
